...
export default class SuccessTransaction extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      url: "",
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flex: 1, padding: 10 }}>
          <Text style={{ paddingTop: 10 }}>Transaction successful</Text>
          <Text>Transaction ID : {this.state.transactionId}</Text>
          <Text style={{ marginTop: 50 }}>
            Thank you for making transaction. You can view certificates.
          </Text>
