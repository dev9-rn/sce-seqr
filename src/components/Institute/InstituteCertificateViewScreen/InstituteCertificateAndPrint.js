...
export default class InstituteCertificateAndPrint extends React.Component {
    ...
    _showHeader() {
        if (Platform.OS == 'ios') {
            return (
                <Header style={{ backgroundColor: '#434e7c' }} hasTabs>
                    <Grid>
            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, }}>
                    <Tabs tabBarUnderlineStyle={{ backgroundColor: 'white' }}  >
                        <Tab heading="View Certificate" tabStyle={{ backgroundColor: '#434e7c' }} textStyle={{ color: '#fff' }}
                            activeTabStyle={{ backgroundColor: '#434e7c', }} activeTextStyle={{ color: 'white', fontWeight: 'bold' }}>

                            <ViewCertificate props={this.props}
                                navigation={this.props.navigation} />
                        </Tab>
                        <Tab heading="View Printing Details" tabStyle={{ backgroundColor: '#434e7c' }} textStyle={{ color: '#fff' }} activeTabStyle={{ backgroundColor: '#434e7c', borderBottomColor: '#434e7c' }} activeTextStyle={{ color: 'white', fontWeight: 'bold' }}>
